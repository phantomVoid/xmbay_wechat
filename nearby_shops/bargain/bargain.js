...
Page({
  ...
  onShareAppMessage: function() {
    return {
      path: '/nearby_shops/bargain/bargain?id=' + this.data.cut_activity_id
    }
  },
  ...
  payOrder() {
    ...
    setTimeout(() => {
      ...
      wx.navigateTo({
        url: '/nearby_shops/confirm_order/confirm_order?info=' + encodeURIComponent(JSON.stringify(obj)) + '&good_image=' + encodeURIComponent(this.data.info.file),
      })
    }, 200)
  },
